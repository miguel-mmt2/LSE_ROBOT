...
//	  if(1) //Vai a frente
//	  	  {
		  	  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_4, 1000 * 0.49);
		  	  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 1000 * 0.50);
	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, 1);
	  		  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, 1);
	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, 0); //aumenta valor encoder
	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, 1);
	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, 0);
	  		  HAL_Delay(5000);
//	  	  }
//	  else if(1) //Vai para tras
//	  {
//		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, 1);
...
//	  		  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 1000 * 0.25);
//	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, 1);
//	  		  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, 0); //diminui valor encoder
//	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_7, 1);
//	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, 1);
//	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, 0);
//	  		  HAL_Delay(1265);

//	  else if(1) //Vai para direita
//	  	  {
//		  	  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_4, 1000 * 0.50);
//		  	  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 1000 * 0.50);
//		  	  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, 1);
